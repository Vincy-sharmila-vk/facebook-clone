...
export default function Video() {
  return (
    <div>
      ...
      <iframe src="https://www.youtube.com/embed/qz0aGYrrlhU?si=03b1iZzgalzXXFV5" title="YouTube video player" 
      frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
        </iframe>
        </div>
        <div className='Container-video' style={{marginTop:'30px'}}>
        <div className='d-flex m-3'>
        ...
        <iframe src="https://www.youtube.com/embed/8xpEuu0s1A4?si=idPhRZeJNfCrklXV" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
        ...
        <iframe src="https://www.youtube.com/embed/dBUBYz75gdk?si=M8Ryld3qZgDj9v_C" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
        ...
        <iframe src="https://www.youtube.com/embed/uLQRrc6ODaY?si=IdKd21cWsa7M-qKX" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
